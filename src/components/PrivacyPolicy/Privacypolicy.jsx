    ...
    <div>
      ...
      <section className="common-content-area">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <strong> Last updated: November 26, 2022 </strong>
              <br /> <br />
              <p>
              ...
              <h2 id="h2_heading">Interpretation and Definitions</h2>
              <h3 id="h3_heading">Interpretation</h3>
              <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  Company”, “We”, “Us” or “Our” in this Agreement) refers to GBS
                  Systems and Service Pvt. Ltd., 1070A, Munusamy Salai, KK
                ...
                <li>
                  <strong>Website</strong> refers to Laptop Stores & Service
                  Center in South India | GBS Systems, accessible from
              ...
              <ul>
                ...
                <li>
                  By mail: 1070A, Munusamy Salai, KK Nagar, Chennai-600078.
                </li>
              </ul>
            </div>
          </div>
