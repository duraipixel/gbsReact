                    ...
                    <ul className="list-group list-group-flush list-group-action m-0">
                      {
                        products.products.map((product) => (
                          <div key={product.id} className="list-group-item" onClick={() => navigate(`/product-list/${product.product_url}`)}>
                            <div className="d-lg-flex align-items-center g-3">
                              ...
                              <div className="p-3">
                                <div>
                                  <p className="fw-normal text-secondary">{product.product_name}</p>
                                  ...
                                  <div className="action-group mt-4">
                                    ...
                                    <button className="mb-md-0 mb-3 btn btn-outline-primary px-5 fw-semibold">Add to Cart</button>
                                  </div>
                                </div>
                              </div>
                            </div>
