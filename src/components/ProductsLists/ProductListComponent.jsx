                                    ...
                                    <div>
                                        ...
                                        <ul className="config-uration my-2">
                                            {product.overview.map((view) => (
                                                <li key={view.id} className="text-info"> {view.attribute_values} </li>
                                            ))}
                                        </ul>
                                        <div className="action-group">
                                            <AddFavButton action={action} className="mb-md-0 mb-3 btn btn-outline-info rounded-box-circle me-md-3" product={product} />
