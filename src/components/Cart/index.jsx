              ...
              <div className="py-4">
                <div className="col-sm-12 empty-cart-cls text-center">
                  <svg className="col-lg-3" viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxlink="http://www.w3.org/1999/xlink">
                    ...
                    <g id="shopping-bag" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd" transform="translate(721.000000, 630.000000)">
                    ...
                    <g id="glow" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd" transform="translate(768.000000, 615.000000)">
