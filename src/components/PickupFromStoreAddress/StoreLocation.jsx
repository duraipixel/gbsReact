                ...
                stores.map(item => (
                    <li className="list-group-item" key={item.id}>
                        ...
                        <div className="align-c gap-3">
                            ...
                            1070A, Munusamy Salai, Bangaru Colony, K. K. Nagar, Opposite to Bata Showroom, Chennai 600078
                        </div>
                        <div className="align-c gap-3">
                            ...
                            +91 08048008393, +91 98416 71155, +91 98416 60470
                        </div>
                        <div className="align-c gap-3">
