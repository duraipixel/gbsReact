...
const PrefferedProcessor = () => {
  ...
  <div className="row">
    ...
    <img src={corew} alt="" className="img-fluid w-100 poster-image" />
    </div>
    </div>
...
<div className="col">
<div className="proc-img">
<img src={amdr} alt="" className="img-fluid w-100 poster-image" />
</div>
</div>
<div className="col-lg-12">
<h4>Intel® CoreTM Processors</h4>
...
<div class="min-hgt-80">
    ...
    <div className="arival-det">
    <div className="ari-img">
    <img src={Poster5} alt="" className="img-fluid poster-image" />
    <div className="off-prc">
    <h3> 30% <span>OFF</span></h3>
    </div>
    </div>
